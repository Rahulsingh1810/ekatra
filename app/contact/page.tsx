...
Please get back to me regarding my inquiry. Thank you!`
  ...
  return (
    <>
      <Head>
        <title>Contact Ekatra Care | Book Your Car Care Service in Bengaluru</title>
        <meta
          name="description"
          content="Get in touch with Ekatra Care for premium car and bike care services. Visit us in Bengaluru or book online. Open 9 AM - 9 PM daily."
        />
        <meta name="keywords" content="car care contact Bengaluru, book car detailing, car wash near me" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.ekatracare.com/contact" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="glass-morphism rounded-2xl p-4 sm:p-8">
              <iframe
                ...
                title="Ekatra Care Location Map in Bengaluru"
              />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-r from-rose-600 to-red-600 text-white">
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <Button
              ...
              title="Book Car Care Service Now"
            >
              Book Service Now
            </Button>
          </div>
